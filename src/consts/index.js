...
export const SKILLS_PACKS = [
  ...
  },
  {
    ...
    imgUrl: 'https://firebasestorage.googleapis.com/v0/b/first-challenge-nuwe.appspot.com/o/skills%2Fpython.svg?alt=media&token=28d59e58-0601-48ca-a3cc-655dc329cea3',
    score:0
  },
  {
...
export const dataStructures = ({displayName = 'anonimo', photoUrl = '', emailAddress = '', uid = ''}) =>{
  const DATA_STRUCTURES = {
    docPersonal: {
      ...
      ubication:'España',
      headerImage:'https://images.unsplash.com/photo-1543523195-e0613799d7ad?ixid=MnwyNDg4MzV8MHwxfHNlYXJjaHwxfHxwZXJyb3xlbnwwfDJ8fHwxNjI3MDk3MjA4&ixlib=rb-1.2.1',
      email:emailAddress,
      phoneNumber:'+58 555 555 555',
      lookForAJob:'Buscando un trabajo de fullstack sénior',
      stack:[  {
        name: SKILLS_NAME.PYTHON,
        imgUrl: 'https://firebasestorage.googleapis.com/v0/b/first-challenge-nuwe.appspot.com/o/skills%2Fpython.svg?alt=media&token=28d59e58-0601-48ca-a3cc-655dc329cea3',
        score:0
...
export const removeSkillDuplicate = (skills =[{}]) => {
